...
status_t mem_limit_get_iovs(mem_limit_ctx_t* ctx, uintptr_t range_base, size_t range_size,
    ...
    printf("low base %#" PRIxPTR "\n"
           "low len %zu\n"
           "high base %#" PRIxPTR "\n"
           "high len %zu\n"
           "range base %#" PRIxPTR "\n"
           "range len %zu\n",
           low_base, low_len, high_base, high_len, range_base, range_size);
    ...
    DEBUG_ASSERT(low_base + low_len <= range_base + range_end);
    DEBUG_ASSERT(high_base + high_len <= range_base + range_end);
